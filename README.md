# BudgetAmico
Descrizione del Progetto: BudgetAmico / Budget Familiare
...
3.
Tracciamento del Patrimonio (Asset Tracking):
◦
...
◦
Portafogli di Investimento: Per i conti di tipo "Investimento", è disponibile un'interfaccia dedicata per gestire un portafoglio di asset (azioni, criptovalute, ecc.), tracciando quantità, prezzo di acquisto, prezzo attuale, e calcolando guadagni e perdite (G/L).
4.
Budgeting e Analisi:
◦
